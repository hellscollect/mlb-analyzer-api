...
class RankWeights:
    """
    Runtime weight knobs (normalized internally). Matches your query params.
    """
...
class ValueRanker:
    ...
    def _score_elite_avg(self, avg: Optional[float]) -> float:
        ...
        # mild bonus above .300 (kept tiny; this is not a hidden boost)
        bonus = 0.0
    ...
    def score_row(self, ri: RankInputs) -> Dict[str, float]:
        ...
        return {
            "score": composite,
            "score_plus": composite,  # alias for now
