    ...
    *, date_obj: _date,
    ...
    for h in cold_hitters:
        ...
        if h.probable_pitcher_id and h.probable_pitcher_id in hot_pitchers_by_id:
            matched_pitcher = hot_pitchers_by_id[h.probable_pitcher_id]
        elif h.opponent_team and h.opponent_team in probables_by_team:
            p = probables_by_team[h.opponent_team]
            if p.player_id in hot_pitchers_by_id:
                matched_pitcher = hot_pitchers_by_id[p.player_id]
...
# =========================
# Local entrypoint (Render-compatible)
# =========================
